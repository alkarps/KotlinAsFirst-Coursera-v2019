...
fun circleInside(
    ...
    val _b = { _x1: Double, _x2: Double -> (_x1 - _x2).pow(2) }
    val between = sqrt(_b(x1, x2) + _b(y1, y2))
...
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean {
    val pass = { x: Int, y: Int, z: Int -> x <= r && (y <= s || z <= s) }
    return pass(a, b, c) || pass(b, c, a) || pass(c, a, b)
}
